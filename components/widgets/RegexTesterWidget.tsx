...
const RegexTesterWidget: React.FC = () => {
    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div className="md:col-span-3">
          <label className="block text-sm font-semibold text-slate-500 mb-2 uppercase tracking-[0.15em]">Regular Expression</label>
        ...
        <div>
          <label className="block text-sm font-semibold text-slate-500 mb-2 uppercase tracking-[0.15em]">Flags</label>
          <input
            type="text"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div>
          <label className="block text-sm font-semibold text-slate-500 mb-2 uppercase tracking-[0.15em]">Test String</label>
          <textarea
        ...
        <div>
          <div className="flex justify-between items-center mb-2">
            <label className="text-sm font-semibold text-slate-500 uppercase tracking-[0.15em]">Match Results</label>
...
export default RegexTesterWidget;
