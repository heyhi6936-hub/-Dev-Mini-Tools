...
const SqlFormatterWidget: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      <button onClick={format} className="px-6 py-2 rounded-xl bg-slate-900 text-white font-semibold hover:-translate-y-0.5 transition-transform">Format SQL</button>
    </div>
  );
};
